...
static log_level_t      g_category_levels[LOG_CATEGORY_COUNT];   /* <-- include/common/logging.h  log_category_t */
static pthread_mutex_t  g_log_mutex;                             /*                               ^            */
static bool             g_initialized = false;                   /*                         need to check      */
                                                                 /* realiazation -->  137, 162, 183, 290       */
