## Network diagrams and brief description
...
<hr />
| ![](docs/Hierarchical_Network_Model.svg) | **Описание схемы**: Здесь можно описать компоненты схемы. |
|---------------------------------|---------------------------------|

<hr />
| ![](docs/v2.Network_Segment_Topology.svg) | **Описание схемы**: Здесь можно описать компоненты схемы. |
|---------------------------------|---------------------------------|
